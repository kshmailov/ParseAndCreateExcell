...
public class ParseExcelTable {
    ...
    public static TreeMap<String, String> getMapUv(String schemesGroup, String sezonGroup){
        ...
        if (schemesGroup.equals("{Юг}")&&sezonGroup.equals("Текущий_сезон=ЛЕТО")){
            ...
            mapUv.put("10", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН5-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("11", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН6-КЭ]]");
            mapUv.put("12", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН4-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("13", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("14", "[[УВ_ОН1-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("15", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("16", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            ...
            mapUv.put("10", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("11", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН6-КЭ]]");
            mapUv.put("12", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН4-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("13", "[[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("14", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("15", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("16", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("17", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("18", "[[УВ_ОН1-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("19", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("20", "[[УВ_ОН1-КЭ];[УВ_ОН2-КЭ];[УВ_ОН3-КЭ];[УВ_ОН4-КЭ];[УВ_ОН5-КЭ];[УВ_ОН6-КЭ];[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
        }else if (schemesGroup.equals("{Ман}")&&sezonGroup.equals("Текущий_сезон=ЛЕТО")) {
            mapUv.put("1", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("2", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("3", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("4", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("5", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("6", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("7", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("8", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
        }else if (schemesGroup.equals("{Ман}")&&sezonGroup.equals("Текущий_сезон=ЗИМА")) {
            mapUv.put("1", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("2", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("3", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("4", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("5", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("6", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ]]");
            mapUv.put("7", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("8", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("9", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("10", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("11", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("12", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
            mapUv.put("13", "[[УВ_ОН1_ВЧ];[УВ_ОН2_ВЧ];[УВ_ОН3_ВЧ];[УВ_ОН4_ВЧ];[УВ_ОН5_ВЧ];[УВ_ОН6_ВЧ];[УВ_ОН7_ВЧ];[УВ_ОН8_ВЧ];[УВ_ОН9_ВЧ]]");
